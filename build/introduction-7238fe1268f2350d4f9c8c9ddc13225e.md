...
Data Science a field that combines the tools and skill set of other disciplines.
...
The language is high-level, has modern features, and uses syntax that is easy to use.
